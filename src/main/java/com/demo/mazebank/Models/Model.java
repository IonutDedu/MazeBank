...
import com.demo.mazebank.Views.AccountType;
import com.demo.mazebank.Views.ViewFactory;
    ...
    public void evaluateClientCred(String pAddress, String password){
        ...
        try {
            if (resultSet.isBeforeFirst()){
                ...
                //We store dates as strings in SQLite, so we need to convert them to LocalDate
    ...
    public void setClients(){
        ...
        try {
            while (resultSet.next()){
                ...
                pAddress = resultSet.getString("PayeeAddress");
                dateParts = resultSet.getString("Date").split("-");
                date = LocalDate.of(Integer.parseInt(dateParts[0]), Integer.parseInt(dateParts[1]), Integer.parseInt(dateParts[2]));
                checkingAccount = getCheckingAccount(pAddress);
                savingsAccount = getSavingsAccount(pAddress);
